...
@Component({
  selector: 'app-trip-products',
  templateUrl: './trip-products.component.html',
  styleUrls: ['./trip-products.component.scss']
})
export class TripProductsComponent implements OnInit {
