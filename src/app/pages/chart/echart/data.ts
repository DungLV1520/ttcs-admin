...
const dynamicChart: ChartType = {
  ...
  series: [
    ...
    {
      name: "Dynamic Line One",
      type: "line",
      data: dataSecond,
    },
    {
      name: "Dynamic Line Two",
      type: "line",
      data: dataThird,
    },
  ],
